...
/**
 * Strategy interface for stream compression. Follows the Strategy Design
 * Pattern to allow different compression algorithms.
 */
interface CompressionStrategy {
     ...
     * @param estimatedSize Optional estimated size of the input for buffer
     *   optimization
