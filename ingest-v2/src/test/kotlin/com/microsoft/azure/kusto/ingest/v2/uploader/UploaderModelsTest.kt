...
class UploaderModelsTest {
    ...
    fun `UploadMethod values returns all enum constants`() {
        val values = UploadMethod.values()
    ...
    fun `ExtendedContainerInfo creates correctly with DEFAULT method`() {
        val containerInfo = ContainerInfo(
            path = "https://example.blob.core.windows.net/container?sv=2020-08-04&st=..."
        )
        val extended = ExtendedContainerInfo(containerInfo, UploadMethod.DEFAULT)
    ...
    fun `ExtendedContainerInfo creates correctly with STORAGE method`() {
        val containerInfo = ContainerInfo(
            path = "https://storage.blob.core.windows.net/data?sv=2020-08-04&st=..."
        )
        val extended = ExtendedContainerInfo(containerInfo, UploadMethod.STORAGE)
    ...
    fun `ExtendedContainerInfo creates correctly with LAKE method`() {
        val containerInfo = ContainerInfo(
            path = "https://onelake.dfs.fabric.microsoft.com/workspace/lakehouse?sv=2020-08-04&st=..."
        )
    ...
    fun `ExtendedContainerInfo data class equality works`() {
        val containerInfo1 = ContainerInfo("https://url1.blob.core.windows.net?token1")
        val containerInfo2 = ContainerInfo("https://url1.blob.core.windows.net?token1")
        val containerInfo3 = ContainerInfo("https://url2.blob.core.windows.net?token2")
        
        val extended1 = ExtendedContainerInfo(containerInfo1, UploadMethod.DEFAULT)
        val extended2 = ExtendedContainerInfo(containerInfo2, UploadMethod.DEFAULT)
        val extended3 = ExtendedContainerInfo(containerInfo3, UploadMethod.DEFAULT)
        val extended4 = ExtendedContainerInfo(containerInfo1, UploadMethod.STORAGE)
    ...
    fun `ExtendedContainerInfo data class hashCode works`() {
        val containerInfo = ContainerInfo("https://url.blob.core.windows.net?token")
        val extended1 = ExtendedContainerInfo(containerInfo, UploadMethod.DEFAULT)
        val extended2 = ExtendedContainerInfo(containerInfo, UploadMethod.DEFAULT)
    ...
    fun `ExtendedContainerInfo data class copy works`() {
        val containerInfo = ContainerInfo("https://url.blob.core.windows.net?token")
        val original = ExtendedContainerInfo(containerInfo, UploadMethod.DEFAULT)
    ...
    fun `ExtendedContainerInfo copy can change containerInfo`() {
        val containerInfo1 = ContainerInfo("https://url1.blob.core.windows.net?token1")
        val containerInfo2 = ContainerInfo("https://url2.blob.core.windows.net?token2")
        val original = ExtendedContainerInfo(containerInfo1, UploadMethod.DEFAULT)
