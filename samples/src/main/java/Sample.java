...
public class Sample {
    ...
    public static void main(String[] args) {
        try {
            ...
            //com.microsoft.azure.kusto.ingest.AzureStorageHelper.postMessageToQueue2("aaa", "aaa", 1);
            ...
            //com.microsoft.azure.kusto.data.KustoConnectionStringBuilder kcsb = com.microsoft.azure.kusto.data.KustoConnectionStringBuilder.createWithAadUserCredentials(dmClusterUrl, userUsername, userPassword, authorityId);
            ...
            //com.microsoft.azure.kusto.data.KustoResults results = kustoClient.execute(databaseName, String.format("%s | count", tableName));

            // Get a lost of EventHub connection string from the DM cluster using com.microsoft.azure.kusto.data.KustoClient
            //com.microsoft.azure.kusto.data.KustoResults eventHubSourceSettings = kustoClient.execute(CslCommandGenerator.generateDmEventHubSourceSettingsShowCommand());
            ...
            KustoIngestionProperties ingestionProperties = new KustoIngestionProperties(databaseName, tableName);
