...
class StreamingIngestClientTest {
    ...
    void setUpEach() throws Exception {
        ...
        when(streamingClientMock.executeStreamingIngest(
                        any(String.class),
                        any(String.class),
    ...
    void IngestFromStream_CsvStream() throws Exception {
        ...
        InputStream inputStream =
                new ByteArrayInputStream(StandardCharsets.UTF_8.encode(data).array());
        StreamSourceInfo streamSourceInfo = new StreamSourceInfo(inputStream);
        OperationStatus status = streamingIngestClient
                .ingestFromStream(streamSourceInfo, ingestionProperties)
                .getIngestionStatusCollection()
                .get(0)
                .status;
        assertEquals(OperationStatus.Succeeded, status);
        verify(streamingClientMock, atLeastOnce())
    ...
    void IngestFromStream_CsvStream_WithClientRequestId() throws Exception {
        ...
        OperationStatus status = streamingIngestClient
                .ingestFromStream(streamSourceInfo, ingestionProperties, clientRequestId)
                .getIngestionStatusCollection()
                .get(0)
                .status;
        assertEquals(OperationStatus.Succeeded, status);
        ArgumentCaptor<ClientRequestProperties> clientRequestPropertiesArgumentCaptor =
                ArgumentCaptor.forClass(ClientRequestProperties.class);
        verify(streamingClientMock, atLeastOnce())
                .executeStreamingIngest(
                        any(String.class),
                        any(String.class),
        ...
        assertEquals(
                clientRequestId,
                clientRequestPropertiesArgumentCaptor.getValue().getClientRequestId());
    }
    ...
    void IngestFromStream_JsonNoMappingReference_IngestionSucceeds()
        ...
        assertEquals(
                "Succeeded",
                ingestionResult.getIngestionStatusCollection().get(0).status.name());
    ...
    void IngestFromStream_JsonWrongMappingKind_IngestionClientException() {
        ...
        assertTrue(ingestionClientException
                .getMessage()
                .contains("Wrong ingestion mapping for format 'json'; mapping kind should be 'Json', but was 'Csv'."));
    }
    ...
    void IngestFromStream_AvroWrongMappingKind_IngestionClientException() {
        ...
        assertTrue(ingestionClientException
                .getMessage()
                .contains("Wrong ingestion mapping for format 'avro'; mapping kind should be 'Avro', but was 'Csv'."));
    }
    ...
    void IngestFromStream_CaughtDataClientException_IngestionClientException() throws Exception {
        when(streamingClientMock.executeStreamingIngest(
                        ...
                        isNull(),
                        any(boolean.class)))
                .thenThrow(DataClientException.class);
    ...
    void IngestFromStream_CaughtDataServiceException_IngestionServiceException() throws Exception {
        when(streamingClientMock.executeStreamingIngest(
                        ...
                        isNull(),
                        any(boolean.class)))
                .thenThrow(DataServiceException.class);
    ...
    void IngestFromFile_Csv() throws Exception {
        ...
        OperationStatus status = streamingIngestClient
                .ingestFromFile(fileSourceInfo, ingestionProperties)
                .getIngestionStatusCollection()
                .get(0)
                .status;
        assertEquals(OperationStatus.Succeeded, status);
    ...
    void IngestFromFile_GivenStreamingIngestClientAndDmEndpoint_ThrowsIngestionClientException() throws Exception {
        ...
        doThrow(dataClientException)
                ...
                .executeStreamingIngest(
                        ...
                        isNull(),
                        eq(false));
        when(streamingClientMock.execute(Commands.VERSION_SHOW_COMMAND))
                .thenReturn(new KustoOperationResult(
    ...
    @Test
    void IngestFromFile_JsonNoMappingKind_IngestionSuccess()
            throws IngestionClientException, IngestionServiceException, URISyntaxException, StorageException {
        String path = resourcesDirectory + "testdata.json";
        FileSourceInfo fileSourceInfo = new FileSourceInfo(path, new File(path).length());
        IngestionResult ingestionResult = streamingIngestClient.ingestFromFile(fileSourceInfo, ingestionProperties);
    ...
    void IngestFromBlob() throws Exception {
        ...
        OperationStatus status = streamingIngestClient
                .ingestFromBlob(blobSourceInfo, ingestionProperties, cloudBlockBlob)
                .getIngestionStatusCollection()
                .get(0)
                .status;
        assertEquals(OperationStatus.Succeeded, status);
    ...
    void IngestFromBlob_InvalidBlobPath_IngestionClientException() {
        ...
        assertTrue(ingestionClientException
                .getMessage()
                .contains("Unexpected error when ingesting a blob - Invalid blob path."));
    }
    ...
    void IngestFromResultSet() throws Exception {
        ...
        OperationStatus status = streamingIngestClient
                .ingestFromResultSet(resultSetSourceInfo, ingestionProperties)
                .getIngestionStatusCollection()
                .get(0)
                .status;
        assertEquals(OperationStatus.Succeeded, status);
    ...
    public static String jsonDataUncompressed =
            "{\"Name\":\"demo1\",\"Code\":\"091231\"}\n" + "{\"Name\":\"demo11\",\"Code\":\"091232\"}\n"
