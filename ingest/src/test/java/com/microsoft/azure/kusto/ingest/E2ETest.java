...
class E2ETest {
    ...
    public static void tearDown() {
        try {
            new ExponentialRetry<DataServiceException, DataClientException>(2).execute(attempt -> queryClient.execute(DB_NAME, String.format(".drop table %s ifexists skip-seal", tableName)));
            ingestClient.close();
