...
public class CslDateTimeFormat extends CslFormat {
    ...
    private static final DateTimeFormatter DATE_TIME_FORMATTER =
            DateTimeFormatter.ofPattern(KUSTO_DATETIME_PATTERN).withZone(ZoneId.of("UTC"));
    ...
    public CslDateTimeFormat(String localDateTimeString) {
        if (StringUtils.isBlank(localDateTimeString)) {
            ...
            localDateTimeString =
                    parseValueFromValueWithType(localDateTimeString, getType()).trim();
            localDateTimeString =
                    CslStringFormat.parseStringLiteral(localDateTimeString).trim();
