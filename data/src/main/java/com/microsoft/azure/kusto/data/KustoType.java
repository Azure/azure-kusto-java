...
public class KustoType<C> {
    ...
    public static final KustoType<Long> LONG = new KustoType<>(Long.class, o -> Long.valueOf(Number.class.cast(o).longValue()));
    ...
    public static final KustoType<Float> REAL_FLOAT = new KustoType<>(Float.class, o -> Float.valueOf(Double.class.cast(o).floatValue()));
