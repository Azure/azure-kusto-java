...
public class KustoType<C> {
    ...
    public static final KustoType<Long> LONG =
            new KustoType<>(Long.class, o -> Long.valueOf(Number.class.cast(o).longValue()));
    ...
    public static final KustoType<Float> REAL_FLOAT =
            new KustoType<>(Float.class, o -> Float.valueOf(Double.class.cast(o).floatValue()));

    public static final KustoType<ZonedDateTime> DATETIME_ZONED_DATE_TIME =
            new KustoType<>(ZonedDateTime.class, o -> ZonedDateTime.parse(o.toString()));
    public static final KustoType<Instant> DATETIME_INSTANT =
            new KustoType<>(Instant.class, o -> Instant.parse(o.toString()));
    public static final KustoType<Long> DATETIME_LONG =
            new KustoType<>(Long.class, o -> Instant.parse(o.toString()).toEpochMilli());
