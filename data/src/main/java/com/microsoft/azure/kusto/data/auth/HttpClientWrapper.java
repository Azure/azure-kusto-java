...
public class HttpClientWrapper implements com.azure.core.http.HttpClient, IHttpClient {
    ...
    public Mono<HttpResponse> send(HttpRequest httpRequest) {
        ...
        if (body != null) {
            ...
            boolean isRequest = httpRequest.getHttpMethod() == com.azure.core.http.HttpMethod.POST
                    || httpRequest.getHttpMethod() == com.azure.core.http.HttpMethod.PUT || httpRequest.getHttpMethod() == com.azure.core.http.HttpMethod.PATCH
                    || httpRequest.getHttpMethod() == com.azure.core.http.HttpMethod.DELETE;
            contentType = header != null ? ContentType.parse(header)
                    : (isRequest ? ContentType.APPLICATION_FORM_URLENCODED : ContentType.APPLICATION_OCTET_STREAM);
    ...
    public IHttpResponse send(com.microsoft.aad.msal4j.HttpRequest httpRequest) throws Exception {
        ...
        contentType = header != null ? ContentType.parse(header)
                : (httpRequest.httpMethod() == HttpMethod.GET ? ContentType.APPLICATION_OCTET_STREAM : ContentType.APPLICATION_FORM_URLENCODED);
